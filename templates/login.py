...
class Login(object):
    ...
    def default(self, username=None, from_page=''):
        ...
        with doc.head:
            ...
            link(rel='stylesheet', href=core.URL_BASE + '/auth/static/css/style.css?v=01.16')
            link(rel='stylesheet', href=core.URL_BASE + '/auth/static/css/{}/style.css?v=01.16'.format(core.CONFIG['Server']['theme']))
            link(rel='stylesheet', href=core.URL_BASE + '/auth/static/css/login.css?v=01.16')
            link(rel='stylesheet', href=core.URL_BASE + '/auth/static/css/{}/login.css?v=01.16'.format(core.CONFIG['Server']['theme']))
