...
class Head(object):
    ...
    def insert():
        ...
        link(rel='stylesheet', href=core.URL_BASE + '/static/css/style.css?v=01.26')
        link(rel='stylesheet', href=core.URL_BASE + '/static/css/{}/style.css?v=01.26'.format(core.CONFIG['Server']['theme']))
