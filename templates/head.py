...
class Head(object):
    ...
    def insert():
        ...
        link(rel='stylesheet', href=core.URL_BASE + '/static/css/style.css?v=02.22')
        link(rel='stylesheet', href=core.URL_BASE + '/static/css/{}style.css?v=02.22'.format(core.CONFIG['Server']['theme']))
