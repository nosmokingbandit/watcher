...
class Head(object):
    ...
    def insert():
        ...
        link(rel='stylesheet', href=core.URL_BASE + '/static/css/style.css?v=01.29')
        link(rel='stylesheet', href=core.URL_BASE + '/static/css/{}/style.css?v=01.29'.format(core.CONFIG['Server']['theme']))
        ...
        script(type='text/javascript', src=core.URL_BASE + '/static/js/notification/main.js?v=01.26')
