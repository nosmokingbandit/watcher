...
class Head(object):
    ...
    def insert():
        ...
        link(rel='stylesheet', href=core.URL_BASE + '/static/css/style.css?v=01.16')
        link(rel='stylesheet', href=core.URL_BASE + '/static/css/{}/style.css?v=01.16'.format(core.CONFIG['Server']['theme']))
        ...
        script("toastr.options.positionClass = 'toast-bottom-left'; toastr['update'] = toastr['info'];toastr.options.preventDuplicates = true;", type='text/javascript')
