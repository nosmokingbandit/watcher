...
class Status():
    ...
    def default(self):
        ...
        with doc.head:
            Head.insert()
            link(rel='stylesheet', href=core.URL_BASE + '/static/css/status.css?v=01.24')
            link(rel='stylesheet', href=core.URL_BASE + '/static/css/{}/status.css?v=01.24'.format(core.CONFIG['Server']['theme']))
            link(rel='stylesheet', href=core.URL_BASE + '/static/css/movie_status_popup.css?v=01.24')
            link(rel='stylesheet', href=core.URL_BASE + '/static/css/{}/movie_status_popup.css?v=01.24'.format(core.CONFIG['Server']['theme']))
